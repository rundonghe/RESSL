...
scheduler=InverseDecaySheduler(num_training_steps=100000)
# augmentation
...
discriminator_scheduler=InverseDecaySheduler()
discriminator_scheduler_separate=InverseDecaySheduler()
eps=0.0014
