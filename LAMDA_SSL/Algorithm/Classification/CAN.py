...
class CDD(object):
    def __init__(self, num_layers=1, kernel_num=(5, 5), kernel_mul=(2, 2),
                 num_classes=31, intra_only=False,device='cpu', **kwargs):
...
# self.discrepancy_key = 'cdd'
# self.clustering = Clustering(self.EPS,
#                                 self.FEAT_KEY,
#                                 self.BUDGET)
