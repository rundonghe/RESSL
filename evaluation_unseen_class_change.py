...
if __name__ == '__main__':
    ...
    for seed in range(3):
        ...
        T_X, T_y = all_labeled_X[all_labeled_y >= int(num_classes / 2 + num_classes / 2 - args.unseen_class_num)], all_labeled_y[
            all_labeled_y >= int(num_classes / 2 + num_classes / 2 - args.unseen_class_num)]
